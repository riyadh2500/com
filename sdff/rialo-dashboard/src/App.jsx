        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <div style={{ width: 26, height: 26, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="26" height="26" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M40 25C40 17.268 46.268 11 54 11H90C97.732 11 104 17.268 104 25V35C104 42.732 97.732 49 90 49H54C46.268 49 40 42.732 40 35V25Z" fill="#E8EAED"/>
              <path d="M16 55C16 47.268 22.268 41 30 41H66C73.732 41 80 47.268 80 55V65C80 72.732 73.732 79 66 79H30C22.268 79 16 72.732 16 65V55Z" fill="#E8EAED"/>
              <path d="M50 85C50 77.268 56.268 71 64 71C71.732 71 78 77.268 78 85V95C78 102.732 71.732 109 64 109C56.268 109 50 102.732 50 95V85Z" fill="#E8EAED"/>
            </svg>
          </div>
